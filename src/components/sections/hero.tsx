    ...
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 pt-16">
      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        ...
        <motion.p
          ...
          className="mb-2 text-base font-medium text-foreground/90 sm:text-lg"
        >
          {profile.role}
        </motion.p>
        ...
        <motion.p
          ...
          className="mx-auto mb-6 flex max-w-2xl items-center justify-center gap-1.5 text-sm text-muted-foreground"
        >
